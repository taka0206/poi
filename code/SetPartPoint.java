...
public class SetPartPoint {
  ...
  public void Run(String mode) {
    ...
    // 例のシロモノ、RichTextStringのインスタンスを生成する。
    RichTextString rt = mode.equals("2003") ? new HSSFRichTextString("Hello POI World♪") :
                            new XSSFRichTextString("Hello POI World♪");
    // 2種類のフォントを生成
    Font fnt1 = workBook.createFont();
    fnt1.setFontName("ＭＳ 明朝");
    fnt1.setFontHeightInPoints((short)22);
